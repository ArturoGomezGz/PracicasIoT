...
class Conexion:
    def __init__(self, jsonBaseDeDatos):
        ...
        #self.stringConexion = f'DRIVER={{{self.dbDriver}}};SERVER={self.dbServer};PORT={self.dbPort};DATABASE={self.dbDatabase};Trusted_Connection=yes;'
        self.stringConexion = 'DRIVER={MySQL ODBC 8.0 Driver}; SERVER=192.168.3.125; UID=arturo; PWD=Pword1; DATABASE=distancia;'
        self.conexion = None
        self.cursor = None
